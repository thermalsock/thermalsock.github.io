...
(function (global) {
  ...
  var CSS = [
    ...
    '.ts-help{background:#EDE6D6;border:1px solid rgba(43,38,32,0.22);border-radius:14px;',
    ...
    '  font-family:"Newsreader",Georgia,serif;color:#2B2620;',
    ...
    '.ts-help h2{font-family:"Fraunces",Georgia,serif;font-weight:600;font-size:22px;margin:0;}',
    '.ts-help-close{background:none;border:none;cursor:pointer;font-size:20px;line-height:1;',
    '  color:#8A8070;padding:4px 6px;border-radius:6px;}',
    '.ts-help-close:hover{color:#8B4A2B;background:rgba(139,74,43,0.10);}',
    '.ts-help-sub{font-family:"IBM Plex Mono",ui-monospace,monospace;font-size:10.5px;',
    '  letter-spacing:0.1em;text-transform:uppercase;color:#8A8070;margin:0 0 18px 0;}',
    '.ts-help-group{font-family:"IBM Plex Mono",ui-monospace,monospace;font-size:9.5px;',
    '  letter-spacing:0.12em;text-transform:uppercase;color:#8A8070;',
    ...
    '.ts-help-key{font-family:"IBM Plex Mono",ui-monospace,monospace;font-size:11px;',
    '  background:#E4DBC7;border:1px solid rgba(43,38,32,0.22);border-bottom-width:2px;',
    '  border-radius:5px;padding:2px 7px;color:#2B2620;white-space:nowrap;}',
    '.ts-help-label{font-size:14px;color:#5C5346;}',
