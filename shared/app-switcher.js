...
(function () {
  ...
  var CSS = [
    '.ts-switcher{position:relative;font-family:"IBM Plex Mono",ui-monospace,monospace;}',
    ...
    '  color:#5C5346;background:rgba(43,38,32,0.04);border:1px solid rgba(43,38,32,0.22);',
    '  border-radius:999px;padding:7px 14px;line-height:1;transition:border-color .2s,color .2s,background .2s;}',
    '.ts-switcher-btn:hover{color:#2B2620;border-color:#8B4A2B;background:rgba(139,74,43,0.08);}',
    '.ts-switcher-btn:focus-visible{outline:2px solid #8B4A2B;outline-offset:2px;}',
    ...
    '  background:#EDE6D6;border:1px solid rgba(43,38,32,0.22);border-radius:12px;',
    ...
    '.ts-switcher-group{font-size:9.5px;letter-spacing:0.12em;text-transform:uppercase;color:#8A8070;',
    '  padding:10px 10px 6px 10px;}',
    '.ts-switcher-group:first-child{padding-top:4px;}',
    '.ts-switcher-link{display:block;text-decoration:none;color:#2B2620;padding:7px 10px;border-radius:7px;',
    '  transition:background .15s;}',
    '.ts-switcher-link:hover{background:rgba(139,74,43,0.10);}',
    '.ts-switcher-link:focus-visible{outline:2px solid #8B4A2B;outline-offset:-2px;}',
    '.ts-switcher-name{display:block;font-family:Fraunces,Georgia,serif;font-size:14px;font-weight:600;line-height:1.25;}',
    '.ts-switcher-blurb{display:block;font-size:10px;letter-spacing:0.03em;color:#8A8070;margin-top:2px;}',
    '.ts-switcher-link[aria-current="page"]{background:rgba(139,74,43,0.13);}',
    '.ts-switcher-link[aria-current="page"] .ts-switcher-name{color:#8B4A2B;}',
    '.ts-switcher-foot{border-top:1px solid rgba(43,38,32,0.14);margin-top:8px;padding-top:8px;}',
    '.ts-switcher-home{display:block;text-decoration:none;color:#5C5346;font-size:10.5px;',
    '  letter-spacing:0.06em;text-transform:uppercase;padding:7px 10px;border-radius:7px;transition:background .15s,color .15s;}',
    '.ts-switcher-home:hover{background:rgba(139,74,43,0.10);color:#8B4A2B;}',
