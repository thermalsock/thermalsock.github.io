// ratioLibrary.js
// Curated divider combinations, in the same spirit as the Sound Design
// page's preset list — browse for a result rather than reverse-engineering
// ratios from scratch. Each entry describes VCO1/VCO2's own divide
// switches plus VCO2's relation to VCO1, since that's the actual physical
// layout of the instrument's front panel.
...
export const RATIO_PRESETS = [
  {
    ...
    vco2Ratio: { n: 1, direction: 'above' }, // VCO2 unison with VCO1
    vco1: { sub1: 2, sub2: 3 },
    vco2: { sub1: 4, sub2: 3 },
  ...
  },
  {
    ...
    category: 'Open & Stable',
    vco2Ratio: { n: 3, direction: 'above' }, // a fifth above VCO1
    vco1: { sub1: 2, sub2: 4 },
    vco2: { sub1: 2, sub2: 3 },
  ...
  },
  {
    ...
    vco2Ratio: { n: 5, direction: 'above' }, // a major third above VCO1
    vco1: { sub1: 2, sub2: 4 },
    vco2: { sub1: 5, sub2: 8 },
  ...
  },
  {
    ...
    category: 'Rich & Consonant',
    vco2Ratio: { n: 6, direction: 'above' }, // close to a minor third above VCO1
    vco1: { sub1: 2, sub2: 4 },
    vco2: { sub1: 3, sub2: 6 },
  ...
  },
  {
    ...
    name: 'Seventh Stack',
    category: 'Rich & Consonant',
    vco2Ratio: { n: 7, direction: 'above' }, // a harmonic (flat) seventh above VCO1
    vco1: { sub1: 2, sub2: 3 },
    vco2: { sub1: 4, sub2: 7 },
  ...
  },
  {
    ...
    vco2Ratio: { n: 8, direction: 'above' }, // near-unison, slightly detuned via divider mismatch
    vco1: { sub1: 5, sub2: 7 },
    vco2: { sub1: 6, sub2: 8 },
  ...
  },
  {
    ...
    category: 'Cluster & Dissonant',
    vco2Ratio: { n: 5, direction: 'below' }, // VCO2 tuned well below VCO1
    vco1: { sub1: 3, sub2: 5 },
    vco2: { sub1: 5, sub2: 7 },
