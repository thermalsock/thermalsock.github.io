...
export const dronePack = {
  ...
  synthGuide: {
    ...
    osc1: {
      wave: "sine",
      label: "Sine — fundamental"
    },
    osc2: {
      wave: "sine",
      label: "Sine, +7 st — 3rd harmonic"
    },
    mixer: {
      osc1: .9,
      osc2: .5,
    ...
    reverb: {
      amount: .8,
      label: "Vast space, near-infinite tail"
    },
    delay: {
      amount: .1,
      label: "Minimal — sustain carries this, not repeats"
    }
  },
  lessons: [ {
    ...
    chords: [ chord("C (fundamental)", [ [ "C", 3 ] ], 16) ]
  }, {
    ...
    chords: [ chord("C (fundamental)", [ [ "C", 3 ] ], 8), chord("C + C (octave)", [ [ "C", 3 ], [ "C", 4 ] ], 8) ]
  }, {
    ...
    chords: [ chord("C (fundamental)", [ [ "C", 3 ] ], 8), chord("C + C (octave)", [ [ "C", 3 ], [ "C", 4 ] ], 8), chord("C + C + G (fifth)", [ [ "C", 3 ], [ "C", 4 ], [ "G", 4 ] ], 8) ]
  }, {
    ...
    chords: [ chord("C (fundamental)", [ [ "C", 3 ] ], 8), chord("C + C (octave)", [ [ "C", 3 ], [ "C", 4 ] ], 8), chord("C + C + G (fifth)", [ [ "C", 3 ], [ "C", 4 ], [ "G", 4 ] ], 8), chord("C + C + G + E (third)", [ [ "C", 3 ], [ "C", 4 ], [ "G", 4 ], [ "E", 4 ] ], 8) ]
  }, {
    ...
    chords: [ chord("C", [ [ "C", 3 ] ], 16), chord("Bb", [ [ "Bb", 2 ] ], 16), chord("C", [ [ "C", 3 ] ], 16) ]
  }, {
    ...
    chords: [ chord("C + C + G + E + A", [ [ "C", 3 ], [ "C", 4 ], [ "G", 4 ], [ "E", 4 ], [ "A", 4 ] ], 24) ]
  } ]
};