...
export const hauntologyColourPack = {
  ...
  synthGuide: {
    ...
    reverb: {
      amount: .4,
      label: "Small room, moderate tail"
    },
    delay: {
      amount: .35,
      label: "1/8 note, moderate feedback"
    }
  },
  lessons: [ {
    ...
    chords: [ chord("G major", [ [ "G", 3 ], [ "D", 4 ], [ "B", 4 ] ]), chord("E major", [ [ "E", 3 ], [ "G#", 3 ], [ "B", 4 ] ]), chord("B major", [ [ "B", 3 ], [ "D#", 4 ], [ "F#", 4 ], [ "B", 4 ] ]) ]
  }, {
    ...
    chords: [ chord("Eb major", [ [ "Eb", 3 ], [ "G", 3 ], [ "Bb", 3 ] ]), chord("F major", [ [ "F", 3 ], [ "A", 3 ], [ "C", 4 ] ]), chord("C major", [ [ "E", 3 ], [ "G", 3 ], [ "C", 4 ] ]) ]
  }, {
    ...
    chords: [ chord("Am (dyad)", [ [ "A", 3 ], [ "C", 4 ] ]), chord("Cm (dyad)", [ [ "C", 4 ], [ "Eb", 4 ] ]), chord("Gm (dyad)", [ [ "G", 3 ], [ "Bb", 3 ] ]), chord("Am (dyad)", [ [ "A", 3 ], [ "C", 4 ] ]) ]
  }, {
    ...
    chords: [ chord("C#m", [ [ "C#", 3 ], [ "E", 3 ], [ "G#", 3 ] ]), chord("G#m/C#", [ [ "C#", 3 ], [ "G#", 3 ], [ "B", 3 ], [ "D#", 4 ] ]), chord("Em", [ [ "E", 3 ], [ "G", 3 ], [ "B", 3 ] ]), chord("F#m", [ [ "F#", 3 ], [ "A", 3 ], [ "C#", 4 ] ]), chord("C#m", [ [ "C#", 3 ], [ "E", 3 ], [ "G#", 3 ] ]) ]
  }, {
    id: "haunt2-add9-lead",
    title: "Add9 Lead",
    ...
    chords: [ chord("F#add9", [ [ "F#", 3 ], [ "A#", 3 ], [ "C#", 4 ], [ "G#", 4 ] ]), chord("Aadd9", [ [ "A", 3 ], [ "C#", 4 ], [ "E", 4 ], [ "B", 4 ] ]), chord("Eadd9", [ [ "E", 3 ], [ "G#", 3 ], [ "B", 3 ], [ "F#", 4 ] ]), chord("Badd9", [ [ "B", 3 ], [ "C#", 4 ], [ "D#", 4 ], [ "F#", 4 ] ]) ]
  }, {
    ...
    chords: [ chord("F major", [ [ "F", 3 ], [ "A", 3 ], [ "C", 4 ] ]), chord("F major", [ [ "F", 3 ], [ "A", 3 ], [ "C", 4 ] ]), chord("Ebsus4", [ [ "Eb", 3 ], [ "Ab", 3 ], [ "Bb", 3 ] ]), chord("Eb major", [ [ "Eb", 3 ], [ "G", 3 ], [ "Bb", 3 ] ]) ]
  }, {
    ...
    synthGuide: {
      ...
      reverb: {
        amount: .85,
        label: "Huge hall, very long tail"
      },
      delay: {
        amount: .6,
        label: "Long, high feedback — go big here"
      }
    },
    chords: [ chord("Asus2 (from A + E)", [ [ "A", 3 ], [ "B", 3 ], [ "E", 4 ] ]), chord("C6 (from C + A)", [ [ "C", 3 ], [ "E", 3 ], [ "G", 3 ], [ "A", 3 ] ]), chord("Cmaj7 (from C + E)", [ [ "C", 3 ], [ "E", 3 ], [ "G", 3 ], [ "B", 3 ] ]) ]
  }, {
    ...
    synthGuide: {
      ...
      reverb: {
        amount: .1,
        label: "Minimal — keep the bass tight and dry"
      },
      delay: {
        amount: .05,
        label: "Off"
    ...
    chords: [ chord("F (bass)", [ [ "F", 2 ] ], 2), chord("E (bass)", [ [ "E", 2 ] ], 2), chord("Gb (bass)", [ [ "Gb", 2 ] ], 2), chord("F (bass)", [ [ "F", 2 ] ], 2) ]
  } ]
};