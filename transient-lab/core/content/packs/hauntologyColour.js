// hauntologyColour.js
//
// DE-IDENTIFIED CONTENT PACK, companion to hauntologyFifths.js -- same
// reasoning: real chord symbols and real harmonic techniques kept,
// artist/track/album naming removed from lesson titles and prose.
// Where Fifths was entirely fifths/fourths dyads, this covers the rest
// of the genre's harmonic vocabulary: writing with only major chords,
// only minor chords, add9/sus4 colours, parallel major/minor mixing,
// and stacking simple shapes into richer chords (sus2/6/maj7).
...
export const hauntologyColourPack = {
  ...
  bpm: 92,
  description:
    "Beyond fifths: writing exclusively with major or minor triads, add9/sus4 colour tones, parallel major/minor mixing, stacking shapes into richer chords, and chromatic bass movement.",

  // Same static-reference-patch idea as the Fifths pack (see
  // ui/canvas/SynthGuide.js), tuned for this pack's brighter,
  // more melodic material (add9 leads, major/minor triads) rather
  // than the Fifths pack's soft drone character.
  synthGuide: {
    title: "Bright Add9 Lead/Pad",
    description:
      "A brighter, more melodic voice for this pack's add9 leads and major/minor triads. OSC2 an octave up adds an airy shimmer on top of OSC1's body. Open the filter further than the fifths patch and add a touch of resonance for bite; a quicker amp attack suits the lead material while the longer filter release keeps pad chords feeling smooth.",
  ...
  lessons: [
...

    {
      ...
      concept:
        "A minor-chord progression in C# minor, with one borrowed chord: G#m over a C# bass. That's the exact same trick as the previous lesson (a minor chord built a minor third above the home root) but here it's a full triad over a held bass note instead of a bare dyad — same idea, richer voicing, eerie quality.",
      // Same gloomy territory as the previous lesson, with a touch
      // more resonance for an eerie quality.
      synthGuide: {
...

    {
      ...
      title: "Add9 Lead",
      concept:
        "Add9 chords (root, 3rd, 5th, 9th) moved around as one fixed shape — F#add9 | Aadd9 | Eadd9 | Badd9, no voice leading, just the same colourful voicing transposed. In B major, the Aadd9 is a borrowed bVII, the same non-diatonic trick as the Borrowed Major lesson's opening chord.",
      chords: [
...

    {
      ...
      concept:
        "Shape-shifting between F major and F minor — 'parallel keys', major and minor sharing the same root. The progression is F | F | Ebsus4 | Eb: the sus4-to-major move on the last two chords (Ebsus4 resolving to Eb) briefly suspends the 3rd before landing, a classic tension-and-release colour inside an otherwise ambiguous major/minor progression.",
      chords: [
        chord("F major", [["F", 3], ["A", 3], ["C", 4]]),
        chord("F major", [["F", 3], ["A", 3], ["C", 4]]),
...

    {
      ...
      concept:
        "No chords at all here — just a bare chromatic bassline: F, a half-step below (E), a half-step above (Gb), then back to F. No harmony to lean on means fewer clash risks for a melody on top, but the bass movement alone carries real tension. A pure single-note bassline exercise, exactly the muscle this app is built to train.",
      // A genuine bassline lesson gets a genuine bass patch -- sub-
      // heavy, dark, punchy, dry -- rather than the pack's bright
      // lead/pad default.
      synthGuide: {
