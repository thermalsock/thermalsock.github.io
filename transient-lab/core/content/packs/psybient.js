// psybient.js
//
// ORIGINAL content pack, not reverse-engineered from any specific
// artist's discography (unlike the Hauntology packs) -- built from
// genuine, sourced genre conventions for psybient/psychill: modal
// harmony (Dorian, Phrygian, Mixolydian), slow harmonic rhythm (chords
// held for multiple bars), oriental/Indian-scale-inflected melodic
// figures, and long-form evolving textures. No specific track is being
// transcribed here; these are original exercises written to teach
// real, documented techniques of the genre.
...
export const psybientPack = {
  ...
  bpm: 80,
  description:
    "Modal harmony over slow harmonic rhythm: Dorian, Phrygian, and Mixolydian colour, sustained chordal beds held for bars at a time, and an oriental-tinged scale for melodic motifs -- the harmonic language of psybient/psychill.",

  synthGuide: {
    title: "Modal Drone Pad",
    description:
      "A warm, slowly-evolving pad built for long-held modal chords. OSC2 an octave up adds airy shimmer without fighting the fundamental. Keep the filter warm and fairly closed, with a slow filter envelope so the tone itself breathes over each held chord; huge reverb and long delay build the immersive, spacious feel the genre is built on.",
  ...
  lessons: [
...

    {
      ...
      concept:
        "E Phrygian's defining feature is a flattened 2nd (F natural sitting a half-step above the root) -- the bII chord (F major) built on that note is the classic 'exotic'/Spanish-tinged Phrygian cadence, a mainstay of psytrance-adjacent writing. i (Em) to bII (F) and back, half-step tension resolving down to the tonic.",
      chords: [
