...
const CHORD_SHAPES = [
    { intervals: [7], suffix: "5" },
    { intervals: [3], suffix: "m" },
    { intervals: [4], suffix: "" },
    { intervals: [5], suffix: "(4th)" },
    { intervals: [2], suffix: "(2nd)" },
    { intervals: [3, 7], suffix: "m" },
    { intervals: [4, 7], suffix: "" },
    ...
    { intervals: [4, 9], suffix: "6" },
    { intervals: [3, 9], suffix: "m6" },
...
export function detectChordName(midiNotes) {
    ...
    if (unique.length === 0)
        return null;
    if (unique.length === 1)
        return NOTE_NAMES[((unique[0] % 12) + 12) % 12];
    const root = unique[0];
